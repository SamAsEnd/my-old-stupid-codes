...
public class EthiopicCalendarTest extends TestCase {
    ...
    private static final EthiopicCalendar ec = new EthiopicCalendar();

    public void testEthiopicToJdnNoArgs() {
        for (int[] EthiopicDay : EthiopicDays) {
            if (EthiopicDay.length == 5) {
                ec.set(EthiopicDay[1], EthiopicDay[2], EthiopicDay[3], EthiopicDay[4]);
            } else {
                ec.set(EthiopicDay[1], EthiopicDay[2], EthiopicDay[3], EthiopicCalendar.JD_EPOCH_OFFSET_AMETE_MIHRET);
            }
            assertEquals("E->JDN Fail: " + EthiopicDay[1] + "/" + EthiopicDay[2] + "/" + EthiopicDay[3], EthiopicDay[0], ec.ethiopicToJDN());
            ec.unset();
        }
    }
    ...
    public void testEthiopicToJdnWithArgs() {
        ...
        for (int[] EthiopicDay : EthiopicDays) {
            ...
            assertEquals("E->JDN Fail: " + EthiopicDay[1] + "/" + EthiopicDay[2] + "/" + EthiopicDay[3], EthiopicDay[0], ec.ethiopicToJDN(EthiopicDay[1], EthiopicDay[2], EthiopicDay[3], era));
        }
    }
    ...
    public void testJdnToEthiopic() {
        int[] eDate;
        for (int[] EthiopicDay : EthiopicDays) {
            eDate = ec.jdnToEthiopic(EthiopicDay[0]);
            assertEquals("<" + EthiopicDay[0] + "> JDN->E Fail[year]: " + EthiopicDay[1] + "/" + EthiopicDay[2] + "/" + EthiopicDay[3], EthiopicDay[1], eDate[0]);
            assertEquals("<" + EthiopicDay[0] + "> JDN->E Fail[month]: " + EthiopicDay[1] + "/" + EthiopicDay[2] + "/" + EthiopicDay[3], EthiopicDay[2], eDate[1]);
            assertEquals("<" + EthiopicDay[0] + "> JDN->E Fail[day]: " + EthiopicDay[1] + "/" + EthiopicDay[2] + "/" + EthiopicDay[3], EthiopicDay[3], eDate[2]);
        }
    }
    ...
    public static void main(String[] args) {
        EthiopicCalendarTest ect = new EthiopicCalendarTest();
        ect.testEthiopicToGregorian();
        ect.testEthiopicToJdnNoArgs();
        ect.testEthiopicToJdnWithArgs();
        ect.testGregorianToEthiopic();
        ect.testJdnToEthiopic();
    }
