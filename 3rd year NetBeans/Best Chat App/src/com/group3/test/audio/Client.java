...
public class Client extends javax.swing.JFrame {
    ...
    private void readAndSend() {
        try {
            String ip = JOptionPane.showInputDialog(this, "Enter the IP?", "IP", JOptionPane.QUESTION_MESSAGE);
            Socket s = new Socket(ip, 21210);

            audioOut = s.getOutputStream();
            //audioIn =  
        } catch (Exception ex) {
            ex.printStackTrace();
        }
