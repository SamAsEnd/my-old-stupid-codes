package com.samasend.algo._4_hill;
...
//        // from Dialog
//        MatrixInputDialog dialog = new MatrixInputDialog(new javax.swing.JFrame(), true);
//        dialog.setVisible(true);
//        cipher.setKeyMatrix(dialog.getMatrix());
//        cipher.printMatrix();
    ...
    public void setKey(String key) {
        ...
        int sqI = (int) sqD;
        if (sqD - sqI != 0.0) { // not perfect squere
